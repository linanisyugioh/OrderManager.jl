...
# 设置 GitHub Token 用于 gh CLI（运行前请设置环境变量 GH_TOKEN）
...
# Windows DLL 文件列表
windows_dll_files = [
   "./release/win64/om.dll",
   "./release/win64/om.lib",
   "./release/win64/libom.lib",
]

# Linux SO 文件列表
linux_so_files = [
   "./release/linux/libom.so",
   "./release/linux/libom.a",
]
